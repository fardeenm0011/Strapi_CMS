    ...
    <form onSubmit={handleSubmit} method='post' className='my-8'>
      <div className='mb-3'>
        ...
        <input
          ...
          name='identifier'
          required
          className='bg-zinc-950 border border-zinc-300 w-full rounded-sm p-2'
      ...
      <div className='mb-3'>
        <button
          type='submit'
          className='bg-blue-500 px-4 py-2 rounded-md disabled:bg-sky-200 disabled:text-gray-400 disabled:cursor-wait'
          disabled={loading}
